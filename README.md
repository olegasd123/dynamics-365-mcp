...
| `get_table_record_details`         | Show one Dataverse table record by id or common name fields. Defaults to active rows and returns structured choices for ambiguous matches.                                                                                           | `environment`, `table`, `recordId`, `name`, `firstName`, `lastName`, `state`, `limit`, `cursor` |
