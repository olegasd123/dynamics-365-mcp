...
const listEnvironmentVariablesSchema = {
...
type ListEnvironmentVariablesParams = ToolParams<typeof listEnvironmentVariablesSchema>;

export async function handleListEnvironmentVariables(
  { environment, nameFilter, solution }: ListEnvironmentVariablesParams,
...
export const listEnvironmentVariablesTool = defineTool({
  name: "list_environment_variables",
  description: "List environment variables with definition and current value metadata.",
  schema: listEnvironmentVariablesSchema,
  handler: handleListEnvironmentVariables,
});
...
export function registerListEnvironmentVariables(
  ...
  registerTool(server, listEnvironmentVariablesTool, { config, client });
}
