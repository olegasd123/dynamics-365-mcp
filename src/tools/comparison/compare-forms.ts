...
type CompareFormsParams = ToolParams<typeof compareFormsSchema>;

export async function handleCompareForms(
  {
    sourceEnvironment,
    targetEnvironment,
    table,
