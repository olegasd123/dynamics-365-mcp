...
const getBusinessUnitsDetailsSchema = {
  environment: z.string().optional().describe("Environment name"),
  businessUnitName: z.string().describe("Business unit name or business unit id"),
};

type GetBusinessUnitsDetailsParams = ToolParams<typeof getBusinessUnitsDetailsSchema>;

export async function handleGetBusinessUnitsDetails(
  { environment, businessUnitName }: GetBusinessUnitsDetailsParams,
...
export const getBusinessUnitsDetailsTool = defineTool({
  name: "get_business_units_details",
  description: "Show one business unit with parent and child context.",
  schema: getBusinessUnitsDetailsSchema,
  handler: handleGetBusinessUnitsDetails,
});
...
export function registerGetBusinessUnitsDetails(
  ...
  registerTool(server, getBusinessUnitsDetailsTool, { config, client });
}
