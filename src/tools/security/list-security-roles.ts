...
export async function handleListSecurityRoles(
  { environment, nameFilter, businessUnit }: ListSecurityRolesParams,
...
export const listSecurityRolesTool = defineTool({
  name: "list_security_roles",
  description: "List security roles with business unit context.",
  schema: listSecurityRolesSchema,
  handler: handleListSecurityRoles,
});
