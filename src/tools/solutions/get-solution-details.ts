...
const getSolutionDetailsSchema = {
  environment: z.string().optional().describe("Environment name"),
  solution: z.string().describe("Solution display name or unique name"),
};

type GetSolutionDetailsParams = ToolParams<typeof getSolutionDetailsSchema>;

export async function handleGetSolutionDetails(
  { environment, solution }: GetSolutionDetailsParams,
  ...
  try {
    ...
    const coverageRows = [
      ...
      ["Environment Variable Definitions", String(inventory.environmentVariableDefinitions.length)],
...
export const getSolutionDetailsTool = defineTool({
  ...
  schema: getSolutionDetailsSchema,
  handler: handleGetSolutionDetails,
});
...
export function registerGetSolutionDetails(
  ...
  registerTool(server, getSolutionDetailsTool, { config, client });
}
