...
type ListSolutionsParams = ToolParams<typeof listSolutionsSchema>;

export async function handleListSolutions(
  { environment, nameFilter, limit, cursor }: ListSolutionsParams,
...
export function registerListSolutions(
  ...
  registerTool(server, listSolutionsTool, { config, client });
}
