...
type GetTableSchemaParams = ToolParams<typeof getTableSchemaSchema>;

export async function handleGetTableSchema(
  { environment, table, solution }: GetTableSchemaParams,
...
export const getTableSchemaTool = defineTool({
  ...
  description: "Show table schema details, including columns, alternate keys, and relationships.",
...
export function registerGetTableSchema(
  ...
  registerTool(server, getTableSchemaTool, { config, client });
}
