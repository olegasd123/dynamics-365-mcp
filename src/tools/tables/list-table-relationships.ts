...
const listTableRelationshipsSchema = {
...
type ListTableRelationshipsParams = ToolParams<typeof listTableRelationshipsSchema>;

export async function handleListTableRelationships(
  { environment, table, solution }: ListTableRelationshipsParams,
...
export const listTableRelationshipsTool = defineTool({
  name: "list_table_relationships",
  description: "List Dataverse table relationships for one table.",
  schema: listTableRelationshipsSchema,
  handler: handleListTableRelationships,
});
...
export function registerListTableRelationships(
  ...
  registerTool(server, listTableRelationshipsTool, { config, client });
}
